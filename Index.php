...
<body>
 ...
 $consulta = $cn->query('select cd_livro,nm_livro,vl_preco,ds_capa,qt_estoque from vw_livro'); // Variavel consulta vai receber vareiavel $cn que receberá o resultado de query
  ?>
