...
<body>
  ...
  include 'conexao.php';
 $consulta = $cn->query('select nm_livro,vl_preco,ds_capa,qt_estoque from vw_livro where sg_lancamento = "S"'); // Variavel consulta vai receber vareiavel $cn que receberá o resultado de query
  ?>
