...
<body>
  ...
  $cat = $_GET['cat'];
 $consulta = $cn->query("select  nm_livro,vl_preco,ds_capa,qt_estoque from vw_livro where ds_categoria =  '$cat'"); // Variavel consulta vai receber vareiavel $cn que receberá o resultado de query
  ?>
  ...
  <div class="container-fluid">
      ...
      <div class="text-center" style="margin-top:5px; margin-bottom:5px;">
          ...
          <?php } else { ?>
            ...
            <button class="btn btn-lg btn-block btn-danger" disabled>
              <span class="glyphicon glyphicon-remove-sign"> Indisponível</span>
          </button>
          <?php } ?>
      </div>
      </div> 
    ...
    </div> <!--dechamento da class row -->
  </div> <!--dechamento do container fluid -->
